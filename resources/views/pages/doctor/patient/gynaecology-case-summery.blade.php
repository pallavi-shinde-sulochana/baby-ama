    ...
    <div class="header ">
        <div class="row sticky-top mx-0 px-4 w-100 align-items-center">
            <div class="col-1 position-absolute">
                <a
                    href="{{ route('doctor.patient.case_summery', ['appoinment' => $appoinment->id, 'patient' => $user->patient->id]) }}">
            ...
            <div class="col-11 text-center">
                ...
                <h2 class="mb-0">Gynaecology Case Summary</h2>
            </div>
        </div>
    </div>
        ...
        <section class="clinical-notes py-4">
            ...
            @if ($getFormAnswers != null)
                ...
                @foreach ($getFormAnswers as $list => $ps)
                    <?php
             $data = isset($ps['gynaecology']) ? json_decode($ps['gynaecology']) : [];
            // print_r($data);
             if ($data!=null) :
                        ...
                        <div class="row px-5 py-4 align-items-center justify-content-between mb-4">
                            ...
                            <div class="col-6 px-0">
                                <a class="baby-secondary-btn border-1 text-center p-2 float-end"
                                    href="{{ route('doctor.appointment.patient.prescription.edit', ['appoinment' => $ps['appointment_id'], 'patient' => $ps['patient_id'], 'id' => $ps['id'], 'type' => 'gynaecology']) }}">Edit
                                </a>
                                <?php endif; ?>
                            </div>
