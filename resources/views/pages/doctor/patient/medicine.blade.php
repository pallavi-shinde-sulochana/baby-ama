                ...
                <div class="med-search-container py-4">
                    <form method="GET" id="searchForm">
                        <div class="row mx-0">
                            ...
                            <div class="col-3">
                                <button type="button" class="baby-primary-btn py-2" data-bs-toggle="modal"
                                    data-bs-target="#addnewdsMed">Add
                                    New</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="med-search-result py-4 mt-4">
                        ...
                        <div class="med-items">
                            ...
                            @php
                            $mtype = helperFormatMedicinePrefix($medicine->type);
                            @endphp

                            <div class="med-item" data-bs-toggle="modal" data-bs-target="#MedPopModal{{ $medicine->id }}">
                            <div class="medicine">
                            @if ($mtype)
                            <span class="m-type pe-1 text-capitalize">({{ $mtype }})</span>
                            @endif
                            <span class="m-name">{{ $medicine->name }} </span>
                            @if ($medicine->dosage)
                             <span class="m-name ms-1"> {{ '(' . $medicine->dosage . ')' }}</span>
                            @endif
                                    </div>
                                </div>
                            @endforeach
...
@php
    ...
    $list_type   = (isset($medicine1->type)) ? helperFormatMedicinePrefix($medicine1->type) : '';
    $list_name   = (isset($medicine1->name)) ? ($medicine1->name) : '';
    $list_dosage = (isset($medicine1->dosage)) ? ($medicine1->dosage) : '';
                ...
                <div class="modal-content">
                    <div class="modal-header py-4">
                        <h3 class="modal-title fs-5 text-center med-name w-100" id=" MedPopModalLabel">
                            ...
                            @if ($list_type)
                            <span class="m-type pe-1 text-capitalize">({{ $list_type }})</span>
                            @endif
                            <span class="m-name">{{ $list_name }} </span>
                            @if ($list_dosage)
                             <span class="m-name ms-1"> {{ '(' . $list_dosage . ')' }}</span>
                            @endif
                    ...
                    <div class="modal-body">
                        <form action="">
                                    ...
                                    <div class="row mx-0 align-items-center">
                                        <div class="col-6 px-1 form-fl">
                                            ...
                                            <input type="number" class="form-control rounded-0"
                                                ...
                                                name="tab_count_days" step="1" min="1"
                                                pattern="[0-9]"
                            ...
                            <div class="row mx-0 mb-4 align-items-center">
                                ...
                                <div class="col-8">
                                    <div class="row mx-0 align-items-center">
                                        <div class="col-6 px-1 form-fld" style="min-width:275px !important;">
                                            <textarea rows="" class="form-control  pb-5" id="notes_{{ $medicine1->id }}" name="notes"><?php if (isset($getdata->notes)) {
                                                echo $getdata->notes;
                                            } ?></textarea>
                                        </div>
                                    </div>
                            ...
                            {{-- <div class="row mx-0 mb-4 align-items-center">
                                <div class="col-12 med-prop position-relative">
                                    Notes
                                </div>
                                <div class="col-12">
                                    <div class="px-1">
...
<!-- add medicine modal end-->
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header py-4">
                                        <h3 class="modal-title fs-5 text-center med-name w-100" id=" MedPopModalLabel">
                                            @php
                                         $listType   = (isset($list_medicine1->type)) ? helperFormatMedicinePrefix($list_medicine1->type) : '';
                                         $listName   = (isset($list_medicine1->name)) ? ($list_medicine1->name) : ucfirst($list_pres1->prescription_name);
                                         $listDosage = (isset($list_medicine1->dosage)) ? ($list_medicine1->dosage) : '';
                                            @endphp
                                            @if ($listType)
                                            <span class="me-2"> {{ '(' . $listType . ')' }}</span>
                                             @endif
                                            {{ ($listName) }}
                                            @if ($listDosage)
                                            <span class="me-2">  {{ '(' . $listDosage . ')' }}</span>
                                            @endif
                                        </h3>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    ...
                                    <div class="modal-body">
                                        <form action="">
                                            ...
                                            {{-- <div class="row mx-0 mb-4 align-items-center">
                                                ...
                                                <div class="col-12">
                                                    <div class=" px-1">
                                                        <textarea rows="" class="form-control pb-5" id="notes_{{ $list_pres1->id }}" name="notes"><?php if (isset($list_pres1->notes)) {
                                                            echo $list_pres1->notes;
                                                        } ?></textarea>
                                                    </div>
                                                </div>
                                            </div> --}}
    ...
    <!-- Add New Med Modal -->
    <div class="modal fade med-data-modal" id="addnewdsMed" tabindex="-1" aria-labelledby="addnewdsMedLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form  action="{{ route('doctor.appointment.patient.prescription.medicine.post', ['appoinment' => $appoinment->id, 'patient' => $user->patient->id]) }}"
                    method="POST">
                    @csrf

                    <input type="hidden" name="pr_id" id="pr_id" value="{{ $data->id }}">
                    <input type="hidden" name="pr_add_new" id="pr_add_new" value="addnew">
                    <input type="hidden" name="prescription_type" id="prescription_type" value="{{ $type }}">

                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addnewdsMedLabel">Add New</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mx-0 mb-4 align-items-center">
                            ...
                            <div class="col-8">
                                <div class="form-fl px-1">

                                    <input type="text" class="form-control rounded-0" placeholder="Name"
                                        id="ps_name" name="prescription_name" value="" required>
                                </div>
                            </div>
                        </div>
                        <!-- Dosage -->
                            ...
                            <div class="col-8">
                                <div class="row justify-content-between align-items-center mx-0">
                                    <div class="col-6 form-fl px-1">
                                        ...
                                        <input type="number" class="form-control rounded-0" placeholder="0"
                                            id="intake_dosage_11" name="intake_qty" value=""
                                            onchange="dosage_incnt(this.value,'11')" step="0.01" min="0.01"
                                           >
                                    </div>
                                    <div class="col-6 form-fl px-1">

                                        <select class="form-control rounded-0" name="dosage" id="dosage_11"
                                            onchange="dosagein(this.value,'11')">
                                            <option value="Tablet">Tablet</option>
                                            <option value="Ml"> ML</option>
                                            <option value="Drop"> Drop</option>
                                            <option value="Other"> Other</option>
                        ...
                        <!-- Timing -->
                        <div class="row mx-0 mb-4 align-items-center">
                            <div class="col-4 med-prop position-relative" id="timing_chkbox_11">
                                Timing
                            </div>
                            <div class="col-8">
                                <div class="row mx-0" id="add_chkbox_11">
                                    <div class="col-4 px-1">
                                        <div class="select-chk">
                                            <input type="checkbox" id="TMorning_11" name="timing_when[]" value="Morning"
                                                class="add_chkbox_11" onclick="chkcnt(11)">
                                            <label for="TMorning">Morning</label>
                                        </div>
                                    </div>
                                    <div class="col-4 px-1">
                                        <div class="select-chk">
                                            <input type="checkbox" id="Tafternoon_11" name="timing_when[]"
                                                value="Noon" class="add_chkbox_11" onclick="chkcnt(11)">
                                            <label for="Tafternoon">Noon</label>
                                        </div>
                                    </div>
                                    <div class="col-4 px-1">
                                        <div class="select-chk">
                                            <input type="checkbox" id="Tevening_11" name="timing_when[]" value="Night"
                                                class="add_chkbox_11" onclick="chkcnt(11)">
                                            <label for="Tevening">Night</label>
                                        </div>
                                    </div>
                        ...
                        <div class="row mx-0 mb-4 align-items-center">
                            ...
                            <div class="col-8">
                                <div class="row mx-0">
                                    ...
                                    <div class="col-6 px-1">
                                        <div class="select-chk">
                                            <input type="radio" id="timing_how" name="timing_how[]" value="afterfood"
                                                checked="">
                                            <label for="food">After Food</label>
                                        </div>
                                    </div>
                                ...
                                <div class="row mx-0 align-items-center">
                                    <div class="col-6 px-1 form-fl">
                                        <!--   <input type="number" class="form-control rounded-0" placeholder="0"
                                                  ...
                                                  -->
                                        <input type="number" class="form-control rounded-0" placeholder="0"
                                            id="totaldays_11" name="tab_count_days" step="1" min="1"
                                            pattern="[0-9]" onkeypress="return !(event.charCode == 46)"
                                            onchange="followUpDays(this.value,'11')" >
                                    </div>
                                    <div class="col-6 px-1">
                                        <label for="FollowUpDays">Days</label>
                                    </div>
                        ...
                        <div class="row mx-0 mb-4 align-items-center">
                            ...
                            <div class="col-8">
                                <div class="row mx-0 align-items-center">
                                    <div class="col-6 px-1 form-fld">
                                        <span class="me-2" id="total_cnt_11">0</span>
                                        <span id="total_dg_11"></span>
                                        <input type="hidden" name="total_qty" id="total_qty_11" value="5">
                                    </div>
                                </div>
                            </div>
                        </div>
                        {{-- <div class="row mx-0 mb-4 align-items-center">
                            <div class="col-12 med-prop">
                                Notes :
                            </div>
                            <div class="col-12 ">
                                <textarea rows="" class="form-control pb-5" id="notes_11" name="notes"></textarea>
                    ...
                    <div class="modal-footer border-0">
                        <button type="reset" class="baby-secondary-btn border-1"
                            data-bs-dismiss="modal">Cancel</button>
