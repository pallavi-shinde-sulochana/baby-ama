            ...
            <div class="row py-5 my-5 mx-0 pediatric-form-fields ">
                <div class="col-12 col-lg-8 col-xl-7 ">
                    <div id="chief_complaints">
                        <label for="chief_complaints" class="form-label">CHIEF COMPLAINTS </label>
                        <textarea rows="" class="form-control mb-5 pb-5" id="chief_complaints" name="chief_complaints"><?php if (isset($get->chief_complaints)) {
                    ...
                    <div class="row mx-0">
                        <div class="col-12 col-lg-6">
                            <div>
                                ...
                                <div class="checkbox-list"><label class="checkbox">
                                        <input type="checkbox" name="gen_examination_1[]" value="Alert"
                                            <?php if (isset($get->gen_examination_1)) {
                                ...
                                <div class="checkbox-list"><label class="checkbox">
                                        <input type="checkbox" name="gen_examination_1[]" value="Awake"
                                            <?php if (isset($get->gen_examination_1)) {
                                ...
                                <div class="checkbox-list"><label class="checkbox">
                                        <input type="checkbox" name="gen_examination_1[]" value="Confused"
                                            <?php if (isset($get->gen_examination_1)) {
                                ...
                                <div class="checkbox-list"><label class="checkbox">
                                        <input type="checkbox" name="gen_examination_1[]" value="Disoriented"
                                            <?php if (isset($get->gen_examination_1)) {
                                ...
                                <div class="checkbox-list"><label class="checkbox">
                                        <input type="checkbox" name="gen_examination_1[]" value="Lethargic"
                                            <?php if (isset($get->gen_examination_1)) {
                                ...
                                <div class="checkbox-list"><label class="checkbox">
                                        <input type="checkbox" name="gen_examination_1[]" value="Obtunded"
                                            <?php if (isset($get->gen_examination_1)) {
                                ...
                                <div class="checkbox-list"><label class="checkbox">
                                        <input type="checkbox" name="gen_examination_1[]" value="Stupor"
                                            <?php if (isset($get->gen_examination_1)) {
                                ...
                                <div class="checkbox-list"><label class="checkbox">
                                        <input type="checkbox" name="gen_examination_1[]" value="Comatose"
                                            <?php if (isset($get->gen_examination_1)) {
                        ...
                        <div class="col-12 col-lg-6">
                            <div>
                                ...
                                ?>
                                <div class="checkbox-list"><label class="checkbox">
                                        <input type="checkbox" name="gen_examination_2[]" value="Pollor"
                                ...
                                <div class="checkbox-list"><label class="checkbox">
                                        <input type="checkbox" name="gen_examination_2[]" value="Icterus"
                                            <?php if (isset($get->gen_examination_2)) {
                                ...
                                <div class="checkbox-list"><label class="checkbox">
                                        <input type="checkbox" name="gen_examination_2[]" value="Cyanosis"
                                            <?php if (isset($get->gen_examination_2)) {
                                ...
                                <div class="checkbox-list"><label class="checkbox">
                                        <input type="checkbox" name="gen_examination_2[]" value="Clubbing"
                                            <?php if (isset($get->gen_examination_2)) {
                                ...
                                <div class="checkbox-list"><label class="checkbox">
                                        <input type="checkbox" name="gen_examination_2[]" value="Edema"
                                            <?php if (isset($get->gen_examination_2)) {
                ...
                <div id="" class="col-12 col-lg-8 col-lg-7 ">
                    ...
                    <div class="field-with-suffix mb-5">
                        ...
                        <input type="text" class="form-field" id="vitals_temperature" name="vitals_temperature"
                            value="<?php if (isset($get->vitals_temperature)) {
                ...
                <div id="" class="col-12 col-lg-8 col-xl-7 ">
                    ...
                    <div class="field-with-suffix mb-5">
                        ...
                        <input type="text" class="form-field" id="anthrapometry_weight" name="anthrapometry_weight"
                            value="<?php if (isset($get->anthrapometry_weight)) {
                    ...
                    <div class="field-with-suffix mb-5">
                        ...
                        <input type="text" class="form-field" id="anthrapometry_height" name="anthrapometry_height"
                            value="<?php if (isset($get->anthrapometry_height)) {
                    ...
                    <div class="field-with-suffix mb-5">
                        ...
                        <input type="text" class="form-field" id="anthrapometry_head_circumference"
                            name="anthrapometry_head_circumference" value="<?php if (isset($get->anthrapometry_head_circumference)) {
                    ...
                    <div class="field-with-suffix mb-5">
                        ...
                        <input type="text" class="form-field" id="mid_arm_circumference" name="mid_arm_circumference"
                            value="<?php if (isset($get->mid_arm_circumference)) {
                ...
                <div id="" class="col-xl-12 col-xxl-6" >
                ...
                <div id="" class="col-12 col-lg-8 col-xl-7 ">
                    <div class="field-with-suffix my-5"> <label for="pa_breathing_cir_temp"
                            class="form-label">Temperature</label> <input type="text" class="form-field"
                            id="pa_breathing_cir_temp" name="pa_breathing_cir_temp" value="<?php if (isset($get->pa_breathing_cir_temp)) {
                ...
                <div id="" class="col-12 col-lg-8 col-xl-7 ">
                    <div id="final_physio_imp">
                        <label for="pa_breathing_fpi" class="form-label"> FINAL PHYSIOLOGICAL IMPRESSION </label>
                        </label>
                        <textarea rows="" class="form-control mb-5 pb-5" id="final_physio_imp" name="final_physio_imp"><?php if (isset($get->final_physio_imp)) {
                            echo $get->final_physio_imp;
                        } ?></textarea>
                    </div>
                ...
                <div id="food_examination_head_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_head"><input type="checkbox"
                                ...
                                <?php if (isset($get->head_foot_examine)) {
                                    if (in_array('hfe_head', $get->head_foot_examine)) {
                                        echo 'checked';
                                    }
                ...
                <div id="food_examination_hair_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_hair"><input type="checkbox"
                                ...
                                <?php if (isset($get->head_foot_examine)) {
                                    if (in_array('hfe_hair', $get->head_foot_examine)) {
                                        echo 'checked';
                                    }
                                } ?>><span> NAD</span></label>
                        <label class="input-fld" for="food_examination_hair">
                            <textarea rows="" class="form-control" id="food_examination_hair" name="food_examination_hair"><?php if (isset($get->food_examination_hair)) {
                ...
                <div id="food_examination_face_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_face"><input type="checkbox"
                                ...
                                <?php if (isset($get->head_foot_examine)) {
                                    if (in_array('hfe_face', $get->head_foot_examine)) {
                                        echo 'checked';
                                    }
                                } ?>><span> NAD</span></label> <label class="input-fld"
                            for="food_examination_face">
                            <textarea rows="" class="form-control" id="food_examination_face" name="food_examination_face"><?php if (isset($get->food_examination_face)) {
                ...
                <div id="food_examination_eyes_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_eyes"><input type="checkbox"
                                ...
                                <?php if (isset($get->head_foot_examine)) {
                                    if (in_array('hfe_eyes', $get->head_foot_examine)) {
                                        echo 'checked';
                                    }
                                } ?>><span> NAD</span></label> <label class="input-fld"
                            for="food_examination_eyes">
                            <textarea rows="" class="form-control" id="food_examination_eyes" name="food_examination_eyes"><?php if (isset($get->food_examination_eyes)) {
                ...
                <div id="food_examination_ears_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_ears"><input type="checkbox"
                            ...
                            for="food_examination_ears">
                            <textarea rows="" class="form-control" id="food_examination_ears" name="food_examination_ears"><?php if (isset($get->food_examination_ears)) {
                ...
                <div id="food_examination_nose_container" class="input-with-checkbox inv-general has-txt-area py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_nose"><input type="checkbox"
                                ...
                                <?php if (isset($get->head_foot_examine)) {
                                    if (in_array('hfe_nose', $get->head_foot_examine)) {
                                        echo 'checked';
                                    }
                                } ?>><span> NAD</span></label> <label class="input-fld"
                            for="food_examination_nose">
                            <textarea rows="" class="form-control" id="food_examination_nose" name="food_examination_nose"><?php if (isset($get->food_examination_nose)) {
                ...
                <div id="food_examination_lips_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_lips"><input type="checkbox"
                                ...
                                <?php if (isset($get->head_foot_examine)) {
                                    if (in_array('hfe_lips', $get->head_foot_examine)) {
                                        echo 'checked';
                                    }
                                } ?>><span> NAD</span></label> <label class="input-fld"
                            for="food_examination_lips">
                            <textarea rows="" class="form-control" id="food_examination_lips" name="food_examination_lips"><?php if (isset($get->food_examination_lips)) {
                ...
                <div id="food_examination_tongue_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_tongue"><input type="checkbox"
                                ...
                                <?php if (isset($get->head_foot_examine)) {
                                    if (in_array('hfe_tongue', $get->head_foot_examine)) {
                                        echo 'checked';
                                    }
                                } ?>><span> NAD</span></label> <label class="input-fld"
                            for="food_examination_tongue">
                            <textarea rows="" class="form-control" id="food_examination_tongue" name="food_examination_tongue"><?php if (isset($get->food_examination_tongue)) {
                ...
                <div id="food_examination_teeth_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_teeth"><input type="checkbox"
                                ...
                                <?php if (isset($get->head_foot_examine)) {
                                    if (in_array('hfe_teeth', $get->head_foot_examine)) {
                                        echo 'checked';
                                    }
                                } ?>><span> NAD</span></label> <label class="input-fld"
                            for="food_examination_teeth">
                            <textarea rows="" class="form-control" id="food_examination_teeth" name="food_examination_teeth"><?php if (isset($get->food_examination_teeth)) {
                ...
                <div id="food_examination_oral_cavity_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_oral_cavity">
                            <input type="checkbox" id="food_examination_oral_cavity" name="head_foot_examine[]"
                                value="hfe_oral" <?php if (isset($get->head_foot_examine)) {
                                    if (in_array('hfe_oral', $get->head_foot_examine)) {
                                        echo 'checked';
                                    }
                                } ?>>
                            <span>
                                NAD</span></label>
                        <label class="input-fld" for="food_examination_oral_cavity">
                            <textarea rows="" class="form-control" id="food_examination_oral_cavity" name="food_examination_oral_cavity"><?php if (isset($get->food_examination_oral_cavity)) {
                ...
                <div id="food_examination_throat_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_throat"><input type="checkbox"
                                id="food_examination_throat" name="head_foot_examine[]" value="hfe_throat"
                                <?php if (isset($get->head_foot_examine)) {
                                    if (in_array('hfe_throat', $get->head_foot_examine)) {
                                        echo 'checked';
                                    }
                                } ?>><span> NAD</span></label>
                        <label class="input-fld" for="food_examination_throat">
                            <textarea rows="" class="form-control" id="food_examination_throat" name="food_examination_throat"><?php if (isset($get->food_examination_throat)) {
                ...
                <div id="food_examination_neck_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_neck"><input type="checkbox"
                                ...
                                <?php if (isset($get->head_foot_examine)) {
                                    if (in_array('hfe_neck', $get->head_foot_examine)) {
                                        echo 'checked';
                                    }
                                } ?>><span> NAD</span></label> <label class="input-fld"
                            for="food_examination_neck">
                            <textarea rows="" class="form-control" id="food_examination_neck" name="food_examination_neck"><?php if (isset($get->food_examination_neck)) {
                ...
                <div id="food_examination_chest_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_chest"><input type="checkbox"
                                ...
                                <?php if (isset($get->head_foot_examine)) {
                                    if (in_array('hfe_chest', $get->head_foot_examine)) {
                                        echo 'checked';
                                    }
                                } ?>><span> NAD</span></label> <label class="input-fld"
                            for="food_examination_chest">
                            <textarea rows="" class="form-control" id="food_examination_chest" name="food_examination_chest"><?php if (isset($get->food_examination_chest)) {
                ...
                <div id="food_examination_abdomen_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_abdomen"><input
                                ...
                                value="hfe_abdomen" <?php if (isset($get->head_foot_examine)) {
                                    if (in_array('hfe_abdomen', $get->head_foot_examine)) {
                                        echo 'checked';
                                    }
                                } ?>><span> NAD</span></label>
                        <label class="input-fld" for="food_examination_abdomen">
                            <textarea rows="" class="form-control" id="food_examination_abdomen" name="food_examination_abdomen"><?php if (isset($get->food_examination_abdomen)) {
                ...
                <div id="food_examination_upper_extermities_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_upper_extermities"><input
                                type="checkbox" id="food_examination_upper_extermities" name="head_foot_examine[]"
                                value="hfe_upper_extermities" <?php if (isset($get->head_foot_examine)) {
                                    if (in_array('hfe_upper_extermities', $get->head_foot_examine)) {
                                        echo 'checked';
                                    }
                                } ?>><span>
                                NAD</span></label> <label class="input-fld" for="food_examination_upper_extermities">
                            <textarea rows="" class="form-control" id="food_examination_upper_extermities"
                                name="food_examination_upper_extermities"><?php if (isset($get->food_examination_upper_extermities)) {
                ...
                <div id="food_examination_lower_extermities_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_lower_extermities"><input
                                type="checkbox" id="food_examination_lower_extermities" name="head_foot_examine[]"
                                value="hfe_lower_extermities" <?php if (isset($get->head_foot_examine)) {
                                    if (in_array('hfe_lower_extermities', $get->head_foot_examine)) {
                                        echo 'checked';
                                    }
                                } ?>><span>
                                NAD</span></label> <label class="input-fld" for="food_examination_lower_extermities">
                            <textarea rows="" class="form-control" id="food_examination_lower_extermities"
                                name="food_examination_lower_extermities"><?php if (isset($get->food_examination_lower_extermities)) {
                ...
                <div id="food_examination_skull_spine_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_skull_spine"><input
                                type="checkbox" id="food_examination_skull_spine" name="head_foot_examine[]"
                                value="hfe_skull_spine" <?php if (isset($get->head_foot_examine)) {
                                    if (in_array('hfe_skull_spine', $get->head_foot_examine)) {
                                        echo 'checked';
                                    }
                                } ?>><span>
                                NAD</span></label>
                        <label class="input-fld" for="food_examination_skull_spine">
                            <textarea rows="" class="form-control" id="food_examination_skull_spine" name="food_examination_skull_spine"><?php if (isset($get->food_examination_skull_spine)) {
                ...
                <div id="food_examination_gentials_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="food_examination_gentials"><input
                                ...
                                value="hfe_gentials" <?php if (isset($get->head_foot_examine)) {
                                    if (in_array('hfe_gentials', $get->head_foot_examine)) {
                                        echo 'checked';
                                    }
                                } ?>><span> NAD</span></label>
                        <label class="input-fld" for="food_examination_gentials">
                            <textarea rows="" class="form-control" id="food_examination_gentials" name="food_examination_gentials"><?php if (isset($get->food_examination_gentials)) {
                        ...
                        <table class="table ">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center"> <input type="text" class="form-control-food w-100px"
                                        name="ss_2months"
                                        value="<?php if (isset($get->ss_2months)) {
                                            echo $get->ss_2months;
                                        } ?>
                                            ">
                                </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">5 Months</td>
                        <td class="text-center"> <input type="text" class="form-control-food w-100px" name="rm_5months"
                            value="<?php if (isset($get->rm_5months)) { echo $get->rm_5months; } ?>">
                                </td>
                            </tr>
                                <tr>
                                    ...
                                    <td class="text-center">6 Months</td>
                                    <td class="text-center"> <input type="text" class="form-control-food w-100px" name="rm_6months"
                                        value="<?php if (isset($get->rm_6months)) { echo $get->rm_6months; } ?>">
                                            </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">9 Months</td>
                                    <td class="text-center"> <input type="text" class="form-control-food w-100px" name="waves_bye_9months"
                                        value="<?php if (isset($get->waves_bye_9months)) { echo $get->waves_bye_9months; } ?>">
                                            </td>                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">12 Months</td>
                                    <td class="text-center"> <input type="text" class="form-control-food w-100px" name="social_adaptive_12months"
                                        value="<?php if (isset($get->social_adaptive_12months)) { echo $get->social_adaptive_12months; } ?>">
                                            </td>                                      </tr>
                                <tr>
                                    ...
                                    <td class="text-center">15 Months</td>
                                    <td class="text-center"> <input type="text" class="form-control-food w-100px" name="jargon_speech_15months"
                                        value="<?php if (isset($get->jargon_speech_15months)) { echo $get->jargon_speech_15months; } ?>">
                                            </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">18 Months</td>
                                    <td class="text-center"> <input type="text" class="form-control-food w-100px" name="copies_parents_18m"
                                        value="<?php if (isset($get->copies_parents_18m)) { echo $get->copies_parents_18m; } ?>">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">2 Years</td>
                                    <td class="text-center"> <input type="text" class="form-control-food w-100px" name="food_toilet_2y"
                                        value="<?php if (isset($get->food_toilet_2y)) { echo $get->food_toilet_2y; } ?>">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">3 Years</td>
                                    <td class="text-center"> <input type="text" class="form-control-food w-100px" name="toys_name_gender_3y"
                                        value="<?php if (isset($get->toys_name_gender_3y)) { echo $get->toys_name_gender_3y; } ?>">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">4 Years</td>
                                    <td class="text-center"> <input type="text" class="form-control-food w-100px" name="co_op_play_4y"
                                        value="<?php if (isset($get->co_op_play_4y)) { echo $get->co_op_play_4y; } ?>">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center">4 Years</td>
                                    <td class="text-center"> <input type="text" class="form-control-food w-100px" name="dress_undress_4y"
                                        value="<?php if (isset($get->dress_undress_4y)) { echo $get->dress_undress_4y; } ?>">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                <!-- <tr>
                                        ...
                                        <td class="text-center"><input type="checkbox"
                                            ...
                                            <?php if (isset($get->language_milestone)) {
                                                if (in_array('alerts_sound', $get->language_milestone)) {
                                                    echo 'checked';
                                                }
                                            } ?> >
                                        </td>
                ...
                <div id="systemic_examination_cvs_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="systemic_examination_cvs"><input
                                type="checkbox" id="systemic_examination_cvs" name="systemic_examination[]"
                                value="se_cvs" <?php if (isset($get->systemic_examination)) {
                                    if (in_array('se_cvs', $get->systemic_examination)) {
                                        echo 'checked';
                                    }
                                } ?>><span> NAD</span></label>
                ...
                <div id="systemic_examination_rs_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="systemic_examination_rs"><input
                                type="checkbox" id="systemic_examination_rs" name="systemic_examination[]"
                                value="se_cvs" <?php if (isset($get->systemic_examination)) {
                                    if (in_array('se_rs', $get->systemic_examination)) {
                                        echo 'checked';
                                    }
                                } ?>><span> NAD</span></label>
                        <label class="input-fld" for="systemic_examination">
                ...
                <div id="systemic_examination_pa_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="systemic_examination_pa"><input
                                type="checkbox" id="systemic_examination_pa" name="systemic_examination[]"
                                value="se_pa" <?php if (isset($get->systemic_examination)) {
                                    if (in_array('se_pa', $get->systemic_examination)) {
                                        echo 'checked';
                                    }
                                } ?>><span> NAD</span></label>
                        <label class="input-fld" for="systemic_examination">
                ...
                <div id="systemic_examination_cns_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="systemic_examination_cns"><input
                                type="checkbox" id="systemic_examination_cns" name="systemic_examination[]"
                                value="se_cns" <?php if (isset($get->systemic_examination)) {
                                    if (in_array('se_cns', $get->systemic_examination)) {
                                        echo 'checked';
                                    }
                                } ?>><span> NAD</span></label>
                        <label class="input-fld" for="systemic_examination">
                ...
                <div id="systemic_examination_le_container" class="input-with-checkbox inv-general py-3">
                    ...
                    <div class="input-fld "><label class="checkbox" for="systemic_examination_le"><input
                                type="checkbox" id="systemic_examination_le" name="systemic_examination[]"
                                value="se_le" <?php if (isset($get->systemic_examination)) {
                                    if (in_array('se_le', $get->systemic_examination)) {
                                        echo 'checked';
                                    }
                                } ?>><span> NAD</span></label>
                        <label class="input-fld" for="systemic_examination">
                            <textarea rows="" class="form-control" id="systemic_examination_le" name="systemic_examination_le">
            <?php if (isset($get->systemic_examination_le)) {
