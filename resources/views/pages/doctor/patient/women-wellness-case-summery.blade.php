    ...
    <div class="header ">
        <div class="row sticky-top mx-0 px-4 w-100 align-items-center">
            ...
            <div class="col-11 text-center">
                ...
                <h2 class="mb-0">Women Wellness Case Summary
                </h2>
            </div>
        </div>
    </div>
    <div class="page-content " style="padding-top:60px;">
        ...
        <section class="clinical-notes py-4">
            ...
            {{-- <div class="row mb-4">
             ...
             <?php
             $data = isset($ps['women_wellness']) ? json_decode($ps['women_wellness']) : [];
           // print_r($data);
             if ($data!=null) :
                    ...
                    <div class="clinical-note baby-border mb-5">
                        <div class="row px-5 py-4 align-items-center justify-content-between mb-4">
                            ...
                            <div class="col-6 px-0">
                                ...
                                href="{{ route('doctor.appointment.patient.prescription.edit', ['appoinment' => $ps['appointment_id'], 'patient' => $ps['patient_id'], 'id' => $ps['id'], 'type' => 'women_wellness']) }}">Edit
                            </a>
                            ...
                            <div class="notes py-2">
                                <div class="summary mb-2">
                                    ...
                                    <p class="answer border-0">
                                        @php echo isset($data->women_wellness_chief_complaints) ? $data->women_wellness_chief_complaints : '-Nil-'; @endphp
                                    </p>
                                </div>
                                <div class="summary mb-2">
                                    <p class="question"> Past Medical History</p>
                                    <p class="answer border-0">
                                        @php echo isset($data->women_wellness_past_medical_history) ? $data->women_wellness_past_medical_history : '-Nil-'; @endphp
                                    </p>
                                </div>
                                <div class="summary mb-2">
                                    <p class="question">Diagnosis</p>
                                    <p class="answer border-0">
                                        @php echo isset($data->women_wellness_diagnosis) ? $data->women_wellness_diagnosis : '-Nil-'; @endphp
                                    </p>
                                </div>
                                <div class="summary mb-2">
                                    <p class="question">Management</p>
                                    <p class="answer border-0">
                                        @php echo isset($data->women_wellness_management) ? $data->women_wellness_management : '-Nil-'; @endphp
                                    </p>
                                </div>
                                {{-- <div class="summary mb-2">
