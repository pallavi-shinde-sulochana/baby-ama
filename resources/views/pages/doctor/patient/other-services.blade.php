...
<div class="head baby-shadow py-3 px-5">
 ...
 <form action="{{ route('doctor.patient.other_services.post', $patient->id) }}" method="POST">
    ...
    <div class="row py-5 my-5 mx-0 pediatric-form-fields ">
        <div id="other_services" class="col-12 col-lg-7 "> <label for="other_services"
                class="form-label">Notes : </label>
            <textarea rows="" class="form-control mb-5 pb-5" id="other_services" name="other_services"><?php if(isset($getdata->other_services)) { echo $getdata->other_services; } ?></textarea>
        </div>
    </div>
