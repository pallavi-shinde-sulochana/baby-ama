        			...
        			<div class="card border shadow-sm p-3 mb-5 bg-body rounded">
                		<div class="card-body py-3 px-5">
                			<div class="row">
                				...
                				@if(isset($data->id))
                        		<a href="{{route('pharmacy.users.delete.pharmacy',$data->id)}}" onclick="return confirm('Are you sure you want to delete this user?');" class="btn btn-sm w-50 btn-danger mb-5 float-end">DELETE USER</a>
                        		@endif
                				</div>
                			</div>
